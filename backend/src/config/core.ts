...
export class Configuration {
  ...
  @ConfigurationMetadata.assign({ comment: "How often to perform data queries for data from providers. Default is once a day at 4am." })
  static updateTime: string = "0 4 * * *";
