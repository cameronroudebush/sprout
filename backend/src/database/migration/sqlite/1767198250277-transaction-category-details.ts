...
export class TransactionCategoryDetails1767198250277 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "temporary_category" ("id" varchar PRIMARY KEY NOT NULL, "userId" varchar NOT NULL, "name" varchar NOT NULL, "type" varchar NOT NULL, "parentCategoryId" varchar, "icon" varchar, CONSTRAINT "UQ_0634179a4275a9ed86e3dae060c" UNIQUE ("name", "userId", "parentCategoryId"), CONSTRAINT "FK_32b856438dffdc269fa84434d9f" FOREIGN KEY ("userId") REFERENCES "user" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_9e5435ba76dbc1f1a0705d4db43" FOREIGN KEY ("parentCategoryId") REFERENCES "category" ("id") ON DELETE SET NULL ON UPDATE NO ACTION)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "transaction_rule" ("id" varchar PRIMARY KEY NOT NULL, "type" varchar NOT NULL, "value" varchar NOT NULL, "strict" boolean NOT NULL, "matches" integer NOT NULL, "order" integer NOT NULL, "enabled" boolean NOT NULL, "userId" varchar, "categoryId" varchar, "accountId" varchar, CONSTRAINT "FK_e77340b6f79dfede390b7180cfb" FOREIGN KEY ("userId") REFERENCES "user" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_abb14d310ab5925f7e067423fb6" FOREIGN KEY ("categoryId") REFERENCES "category" ("id") ON DELETE SET NULL ON UPDATE NO ACTION)`);
        ...
        await queryRunner.query(`ALTER TABLE "transaction_rule" RENAME TO "temporary_transaction_rule"`);
        await queryRunner.query(`CREATE TABLE "transaction_rule" ("id" varchar PRIMARY KEY NOT NULL, "type" varchar NOT NULL, "value" varchar NOT NULL, "strict" boolean NOT NULL, "matches" integer NOT NULL, "order" integer NOT NULL, "enabled" boolean NOT NULL, "userId" varchar, "categoryId" varchar, CONSTRAINT "FK_e77340b6f79dfede390b7180cfb" FOREIGN KEY ("userId") REFERENCES "user" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_abb14d310ab5925f7e067423fb6" FOREIGN KEY ("categoryId") REFERENCES "category" ("id") ON DELETE SET NULL ON UPDATE NO ACTION)`);
        ...
        await queryRunner.query(`CREATE TABLE "category" ("id" varchar PRIMARY KEY NOT NULL, "userId" varchar NOT NULL, "name" varchar NOT NULL, "type" varchar NOT NULL, "parentCategoryId" varchar, CONSTRAINT "UQ_0634179a4275a9ed86e3dae060c" UNIQUE ("name", "userId", "parentCategoryId"), CONSTRAINT "FK_32b856438dffdc269fa84434d9f" FOREIGN KEY ("userId") REFERENCES "user" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_9e5435ba76dbc1f1a0705d4db43" FOREIGN KEY ("parentCategoryId") REFERENCES "category" ("id") ON DELETE SET NULL ON UPDATE NO ACTION)`);
