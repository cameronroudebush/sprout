...
final logoImageProvider = LogoImageFamily._();

/// Riverpod to cache and load the given image with the given data considering an authenticated API

final class LogoImageProvider extends $FunctionalProvider<AsyncValue<Uint8List>,
...
final class LogoImageFamily extends $Family
  ...
  LogoImageProvider call({
    String? faviconUrl,
    String? fullUrl,
  }) =>
      LogoImageProvider._(argument: (
