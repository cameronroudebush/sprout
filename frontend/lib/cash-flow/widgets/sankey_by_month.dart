...
class SankeyFlowByMonth extends StatelessWidget {
  ...
  const SankeyFlowByMonth(this.selectedDate, {super.key});
  ...
  SankeyData? _getSankeyData() {
    ...
    return provider.getSankeyData(selectedDate.year, selectedDate.month);
  }
    ...
    return SproutLayoutBuilder((isDesktop, context, constraints) {
      return Consumer<CashFlowProvider>(
        builder: (context, provider, child) {
          ...
          if (data == null) {
            return const Center(child: TextWidget(text: "Failed to load Cash Flow data."));
          }
          if (data.links.isEmpty) {
            return const Center(child: TextWidget(text: "No cash flow data for this period."));
          }
          ...
          return SizedBox(
            ...
            child: InteractiveViewer(
              ...
              child: SizedBox(
                height: height,
                width: !isDesktop ? 640 : AppTheme.maxDesktopSize - 50,
                child: Center(
