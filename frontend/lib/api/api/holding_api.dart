...
class HoldingApi {
  ...
  /// Get timeline of a specific holding.
  ///
  /// Retrieves the value change over time of a holding given by it's ID.
  ///
  /// Note: This method returns the HTTP [Response].
  ///
  /// Parameters:
  ...
  ///
  /// Retrieves the value and performance history for a single holding given by its ID.
  ///
  /// Note: This method returns the HTTP [Response].
  ///
  /// Parameters:
