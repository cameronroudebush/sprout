...
class RefreshRequestDTO {
  ...
  static RefreshRequestDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'refreshToken'), 'Required key "RefreshRequestDTO[refreshToken]" is missing from JSON.');
        assert(json[r'refreshToken'] != null, 'Required key "RefreshRequestDTO[refreshToken]" has a null value in JSON.');
        return true;
      }());
