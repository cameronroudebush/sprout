...
class UserCreationRequest {
  /// Returns a new [UserCreationRequest] instance.
  UserCreationRequest({
  ...
  /// Returns a new [UserCreationRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static UserCreationRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "UserCreationRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "UserCreationRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<UserCreationRequest> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = UserCreationRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, UserCreationRequest> mapFromJson(dynamic json) {
    final map = <String, UserCreationRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UserCreationRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
