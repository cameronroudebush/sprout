...
class PlaidLinkTokenDTO {
  /// Returns a new [PlaidLinkTokenDTO] instance.
  PlaidLinkTokenDTO({
  ...
  /// Returns a new [PlaidLinkTokenDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PlaidLinkTokenDTO? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<PlaidLinkTokenDTO> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PlaidLinkTokenDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PlaidLinkTokenDTO> mapFromJson(dynamic json) {
    final map = <String, PlaidLinkTokenDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PlaidLinkTokenDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
