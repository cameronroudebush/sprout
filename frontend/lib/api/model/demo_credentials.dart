...
class DemoCredentials {
  /// Returns a new [DemoCredentials] instance.
  DemoCredentials({
  ...
  /// Returns a new [DemoCredentials] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static DemoCredentials? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<DemoCredentials> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = DemoCredentials.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, DemoCredentials> mapFromJson(dynamic json) {
    final map = <String, DemoCredentials>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = DemoCredentials.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
