...
class PlaidLinkDTO {
  /// Returns a new [PlaidLinkDTO] instance.
  PlaidLinkDTO({
  ...
  /// Returns a new [PlaidLinkDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PlaidLinkDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return PlaidLinkDTO(
        publicToken: mapValueOfType<String>(json, r'publicToken')!,
        metadata: PlaidMetadataDTO.fromJson(json[r'metadata'])!,
      );
    }
    return null;
  }
  ...
  static List<PlaidLinkDTO> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PlaidLinkDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PlaidLinkDTO> mapFromJson(dynamic json) {
    final map = <String, PlaidLinkDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PlaidLinkDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
