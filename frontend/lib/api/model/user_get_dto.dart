...
class UserGetDTO {
  /// Returns a new [UserGetDTO] instance.
  UserGetDTO({
  ...
  /// Returns a new [UserGetDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static UserGetDTO? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<UserGetDTO> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = UserGetDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, UserGetDTO> mapFromJson(dynamic json) {
    final map = <String, UserGetDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UserGetDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
