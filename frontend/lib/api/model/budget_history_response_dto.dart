...
class BudgetHistoryResponseDto {
  /// Returns a new [BudgetHistoryResponseDto] instance.
  BudgetHistoryResponseDto({
    this.history = const [],
  });

  /// Historical monthly performance data points.
  ...
  /// Returns a new [BudgetHistoryResponseDto] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static BudgetHistoryResponseDto? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<BudgetHistoryResponseDto> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = BudgetHistoryResponseDto.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, BudgetHistoryResponseDto> mapFromJson(dynamic json) {
    final map = <String, BudgetHistoryResponseDto>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = BudgetHistoryResponseDto.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
