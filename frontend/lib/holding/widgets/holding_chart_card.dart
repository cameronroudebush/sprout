...
/// Renders the AI holdings & investment overview in a card
class HoldingsChatCard extends ConsumerWidget {
  /// Whether the widget is rendering on a mobile screen context
  final bool mobile;

  const HoldingsChatCard({super.key, this.mobile = false});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    Widget content = chatStatusAsync.whenDefault(
      ...
      expanded: false,
      customErrorMessage: "Failed to load holdings overview",
    ...
    return SproutCard(
      child: Column(
        ...
        children: [
          SproutChartHeader(
            title: "24-Hour Portfolio Overview",
            subheader: "Based on last synced closing data",
            left: const Row(
              children: [
                Tooltip(
